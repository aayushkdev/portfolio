      ...
      <div className="flex-grow">
        ...
        <nav className="mt-3 sm:mt-4 lg:mt-12 flex flex-row lg:flex-col lg:space-y-4 space-x-3 sm:space-x-4 lg:space-x-0">
          ...
          <a
            ...
            className="block text-left font-mono text-sm sm:text-base lg:text-lg capitalize transition-all duration-200 text-gray-400 hover:text-white lg:hover:translate-x-1"
          >
            / resume
          </a>

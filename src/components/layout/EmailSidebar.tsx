const EmailSidebar = () => {
  return (
    <div className="fixed right-[40px] max-[1200px]:right-[20px] max-[769px]:right-[10px] bottom-0 z-10 flex flex-col items-center max-[769px]:hidden after:content-[''] after:block after:w-[1px] after:h-[90px] after:bg-slate-light after:mt-[20px]">
      <a
